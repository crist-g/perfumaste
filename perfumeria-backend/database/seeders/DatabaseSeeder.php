...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Product::create([
            ...
            'price' => 2500.00,
            'stock' => 20,
            'image_url' => 'https://via.placehold.co/400x400.png?text=Acqua+Di+Gio',
        ...
        Product::create([
            ...
            'price' => 1200.50,
            'stock' => 50,
            'image_url' => 'https://via.placehold.co/400x400.png?text=CK+One',
            'category_id' => $catCitricos->id,
            'brand' => 'Calvin Klein'
        ]);
        ...
        Product::create([
            ...
            'price' => 3800.00,
            'stock' => 10,
            'image_url' => 'https://via.placehold.co/400x400.png?text=Bleu+De+Chanel',
        ...
        Product::create([
            ...
            'price' => 3200.00,
            'stock' => 15,
            'image_url' => 'https://via.placehold.co/400x400.png?text=Sauvage',
            'category_id' => $catAmaderados->id,
            'brand' => 'Dior'
        ]);
        ...
        Product::create([
            ...
            'price' => 2900.00,
            'stock' => 25,
            'image_url' => 'https://via.placehold.co/400x400.png?text=La+Vie+Est+Belle',
